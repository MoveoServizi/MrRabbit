...
int main(int argc, char **argv)
{
    ...
    unitree_legged_msgs::LED led_color;

    ros::Publisher pub = nh.advertise<unitree_legged_msgs::HighCmd>("high_cmd", 1000);
    ros::Publisher pub_led = nh.advertise<unitree_legged_msgs::LED>("led_topic", 5);
